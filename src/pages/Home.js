...
const Home = () => {
    return (
        <div id='home' className="w-full h-screen bg-gradient-to-r from-gray-800 to-black text-white">
        <div className="max-w-screen-lg mx-auto flex flex-col items-center justify-center h-full px-4 md:flex-row animate-fadeInRight">
          ...
          <div className="flex flex-col justify-center h-full text-center md:text-left md:items-start md:w-1/2">
            ...
            <ReactTyped
              ...
              strings={["Software Developer", "MERN Stack Developer", "Problem Solver"]}
              typeSpeed={50}
              backSpeed={40}
              loop
            />
          ...
          <button className="inline-block bg-orange-500 text-white px-6 py-3 rounded-md shadow-lg hover:shadow-orange-500 transition-all ease-in-out hover:scale-105" >
            <a href="your-resume-link" target="_blank" rel="noopener noreferrer">Resume</a>
          </button>
          <Link
            to="about"
            smooth={true}
